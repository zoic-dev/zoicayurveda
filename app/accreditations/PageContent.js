            ...
            <Container maxWidth="lg">
                ...
                <Box textAlign="center" mb={6}>
                    ...
                    <Typography sx={{ fontSize: 18, color: '#4A4A4A', maxWidth: 800, margin: '0 auto' }}>
                        Zoic Ayurveda is committed to quality, safety, and compliance. Our certifications reflect our dedication to manufacturing premium Ayurvedic and herbal products in adherence to global standards.
                    </Typography>
                </Box>
